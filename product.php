...
$query="select *from product_details where category_id='".$_GET['maincategory']."' order by pid desc LIMIT ".$pageLimit." , ".$setLimit;
}elseif(isset($_GET['subcategory'])){
$query="select *from product_details where sub_category_id='".$_GET['subcategory']."' order by pid desc LIMIT ".$pageLimit." , ".$setLimit;
}elseif(isset($_GET['subsubcategory'])){
$query="select *from product_details where sub_sub_category_id='".$_GET['subsubcategory']."' order by pid desc LIMIT ".$pageLimit." , ".$setLimit;
}else{
