...
<html>
<head>
<title>Buy Mart Trade India</title>
...
.header-login{float:unset !important;}
.carousel {
    position: relative;
...
.indiamartlogos{   
    ...
    width: 23%; text-align: left; float: left;}
...
<div class="container">
		<div class="head">
			<div class=" logo">
                            <a href="index.php"><img class="indiamartlogos" src="images/indiamartlogo.jpg" alt=""></a>	
			</div>
		</div>
	</div>
	<div class="header-top">
		...
		<!--<div class="col-sm-5 col-md-offset-2 header-social">
                ...
                <div class="col-sm-5  header-login" style="">		
					
					<ul>
					<?php if(!isset($_SESSION['ID'])){ ?>
						<li><a href="login.php">Login</a></li>
						<li><a href="register.php">Register</a></li>
                                                <li><a href="vendor_register.php">Vendor Register</a></li>
    ...
    <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
        <ul class="nav navbar-nav nav_1">
            ...
            <?php if(!isset($_SESSION['ID'])){ ?>
						...
						<li role="presentation"><a role="menuitem" tabindex="-1" href="wishlist.php"><i class="fa fa-heart-o"></i> My Wishlist</a></li>
						<li role="presentation"><a role="menuitem" tabindex="-1" href="my-review.php"><i class="fa fa-comment"></i> My Review</a></li>
                                                <li role="presentation"><a role="menuitem" tabindex="-1" href="refferal_users.php"><i class="fa fa-users"></i> My Refferal</a></li>
						<li role="presentation" class="divider"></li>
						<li role="presentation"><a role="menuitem" tabindex="-1" href="#" data-toggle="modal" data-target="#changepasswords"><i class="fa fa-pencil"></i> Change Password</a></li>
						<li role="presentation"><a role="menuitem" tabindex="-1" href="logout.php"> <i class="fa fa-circle-o-notch"></i> Logout</a></li>
						</ul>
		...
		<?php  $maincategory=mysql_query("select category_name,cid from category order by cid asc limit 0,3");  while($cat=mysql_fetch_array($maincategory)) { ?>
    ...
    font-size: 15px;
			...
			<div class="col-sm-2 search-right">
				...
				<span class="glyphicon glyphicon-heart" aria-hidden="true"></span>
                                ...
                                <?php } ?>
                                <li><a class="play-icon popup-with-zoom-anim" title="Search" href="#small-dialog" style="color:white;"><i class="glyphicon glyphicon-search"> </i></a></li>
					</ul>
					<?php if(isset($_SESSION['ID'])) {  ?>
