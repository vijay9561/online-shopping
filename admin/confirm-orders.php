...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
	...
	<div class="row">
		...
		<div class="panel panel-default">
			...
			<?php }else{ ?>
				<a href="confirm-orders.php" class="btn btn-danger">Back</a>
			<?php } ?>
			</div>
...
<input type="submit" class="btn btn-primary" value="Search" onclick="return search_result()" />
					  ...
					  <?php 
                        ...
                        <tr>
                          ...
                          <td><?php echo $row['date']; ?></td>
						   <td>
						   <?php if(isset($_GET['searchkeyowords'])) { ?>
						  <a href="post.php?action=deliveryorders&confirm=<?php echo $row['oid']; ?>&searchkeyowords=<?php echo $_GET['searchkeyowords']; ?>" onclick="return confirm('are you sure to this order delivery');"  class="btn btn-success" title="<?php echo $row['status']; ?>">Delivery Process</a>
						  <?php }else{ ?>
						   <a href="post.php?action=deliveryorders&confirm=<?php echo $row['oid']; ?>" onclick="return confirm('are you sure to this order delivery');"  class="btn btn-success" title="<?php echo $row['status']; ?>">Delivery Process</a>
						  <?php } ?>
						  </td>
                          <td>
						  <?php if(isset($_GET['searchkeyowords'])) { ?>
						  <a href="confirm-orders.php?vieworders=opendata&catid=<?php echo $row['order_id']; ?>&searchkeyowords=<?php echo $_GET['searchkeyowords']; ?>"  class="btn btn-primary" title="Edit"><span class="glyphicon glyphicon-eye-open"></span></a>&nbsp;&nbsp;
						  <?php }else{ ?>
						    <a href="confirm-orders.php?vieworders=opendata&catid=<?php echo $row['order_id']; ?>"  class="btn btn-primary" title="Edit"><span class="glyphicon glyphicon-eye-open"></span></a>&nbsp;&nbsp;
						  <?php } ?>
						 </td>
                        </tr>
						<?php } }else{ ?>
		...
		<div class="row">
				<div class="col-md-12">
				<?php if(isset($_GET['searchkeyowords'])) { echo confirmorderspaginsearch($setLimit,$page,$_GET['searchkeyowords']); }else {echo confirmorderspagin($setLimit,$page);  }?>
		</div>
			</div>
		</div>
		</div>
...
window.location='confirm-orders.php?searchkeyowords='+search_id2;
return false;
}
